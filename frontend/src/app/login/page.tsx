...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start sm:justify-center bg-white sm:bg-slate-50 p-4 pt-12">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-black outline-none transition-all text-[16px] text-black font-medium"
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-12 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-black outline-none transition-all text-[16px] text-black font-medium"
          ...
          <button 
            disabled={loading}
            type="submit" 
            className="w-full bg-black text-white py-5 rounded-[2rem] font-bold text-lg active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl shadow-slate-200"
          >
